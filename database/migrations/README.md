...
| `0018_benchmark_runner` | `0018_benchmark_runner.up.sql`, `0018_benchmark_runner.down.sql` | Reproducible run configuration and isolated case output metadata for TASK-12-02 |
